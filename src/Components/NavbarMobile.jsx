        ...
        <>
            ...
            >
                <Box width={"100vw"} height={"100vh"} padding={"32px 24px 60px"}>
                    ...
                    <Box>
                        ...
                        <Accordion style={{boxShadow: "none", paddingLeft: "-16px"}} disableGutters={true}>
                            <AccordionSummary
                                ...
                                id="panel1bh-header"
                            >
                                <Typography fontSize={18} fontWeight={300} color={"black"}>Võimalused</Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                               <VoimalusedTab/>
                            </AccordionDetails>
                        ...
                        <Accordion style={{boxShadow: "none", paddingLeft: "-16px"}} disableGutters={true}>
                            <AccordionSummary
                                ...
                                id="panel1bh-header"
                            >
                                <Typography fontSize={18} fontWeight={300} color={"black"}>Kujundused</Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                        ...
                        <div>
                            <Accordion style={{boxShadow: "none", paddingLeft: "-16px"}} disableGutters={true}>
                                <AccordionSummary
                                    ...
                                    id="panel1bh-header"
                                >
                                    <Typography fontSize={18} fontWeight={300} color={"black"}>Materjalid</Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <div className="kujundused-list">
                                        <MaterjalidTab/>
                    ...
                    <Box width={"100%"}>
                        <Button className="button-1" variant={"outlined"} fullWidth={true}>Sisene</Button>
                    </Box>
                    <Box width={"100%"} paddingTop={"20px"}>
                        <Button className="button-2" variant={"contained"} fullWidth={true}>Loo veebileht tasuta</Button>
                    </Box>
